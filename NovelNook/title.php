...
<body>
      ...
      <div class="container">
        <div class="row">
          <div id="title" class="col">
            <img src="assets/img/CarouselCard.png" alt="">
            <button onclick="goToNewPage()" type="button" class="btn btn-primary">Читать</button>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">Читаю</a></li>
                <li><a class="dropdown-item" href="#">Буду читать</a></li>
                <li><a class="dropdown-item" href="#">Прочитано</a></li>
                <li><a class="dropdown-item" href="#">Брошено</a></li>
                <li><a class="dropdown-item" href="#">Отложено</a></li>
              </ul>
            </div>
          ...
          <div class="col-9">
            ...
            <div class="info">
              <div id="div_estimation">
                <img class="estimation" src="assets/icons/star.png" alt="" srcset="">
                <p>Оценка</p>
                <p style="margin-left: 8px;">(Кол-во оценок)</p>
              </div>
            ...
            <div class="row">
              <div class="add col-8">
                <button onclick="showContent('description')" type="button"
                  class="add-1 btn btn-outline-secondary">Описаение</button>
                <button onclick="showContent('content')" type="button" class="add-2 btn btn-outline-secondary">Главы (Кол-во)</button>
              ...
              <div class="col">
                <h3>Автор</h3>
                <div id="author">
                  <img src="assets/img/CarouselCard.png" alt="" srcset="">
  ...
  <script src="assets/js/replacement.js"></script>
